...
<head>
  ...
  <body>
	...
	<main role="main" class="container">
      <div class="jumbotron">
        <a class="btn btn-lg btn-primary" href="http://localhost:9999/ReciteWebApp/Review?method=forget" role="button">I Forget it »</a>
		<a class="btn btn-lg btn-primary" href="http://localhost:9999/ReciteWebApp/Review?method=show" role="button">Review Next Time »</a>
		<a class="btn btn-lg btn-primary" href="http://localhost:9999/ReciteWebApp/Review?method=well" role="button">Well Know »</a>
      </div>
    </main>
